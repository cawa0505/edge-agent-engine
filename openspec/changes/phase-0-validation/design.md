...
EdgeAgentDaemon is in Phase 0 validation with no executable codebase. The project aims to validate a single model on Android/ARM64 using Rust for local inference, adapter training, and resource metrics. This OpenSpec change will formalize core capabilities into specifications without pre-defining models, backends, or Android bindings.
...
- Define clear Phase 0 validation boundaries
